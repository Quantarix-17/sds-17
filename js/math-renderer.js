...
// Added: custom LaTeX macros support (\extker, \extrange, etc.)
// ========================================================================

// ===== CUSTOM KATEX MACROS =====
// Define custom LaTeX commands that may appear in AI-generated content
// These will be passed to KaTeX via the 'macros' option
function getCustomKaTeXMacros() {
    return {
        // Linear algebra / extension notation
        ...
        // Bengali/Unicode math operators
        "\\ডিটারমিন্যান্ট": "\\operatorname{ডিটারমিন্যান্ট}",
        "\\ট্রেস": "\\operatorname{ট্রেস}",
        "\\ট্রান্সপোজ": "\\operatorname{ট্রান্সপোজ}",
        "\\র্যাঙ্ক": "\\operatorname{র্যাঙ্ক}",
        "\\কার্নেল": "\\operatorname{কার্নেল}",
        "\\ইমেজ": "\\operatorname{ইমেজ}",
        // Common missing macros
        ...
        "\\MAPE": "\\operatorname{MAPE}",
        "\\SMAPE": "\\operatorname{SMAPE}",
        "\\MASE": "\\operatorname{MASE}",
        "\\MDAPE": "\\operatorname{MDAPE}",
        "\\sMAPE": "\\operatorname{sMAPE}",
        ...
        "\\sinh": "\\sinh",
        "\\cosh": "\\cosh",
        // Some aliases for common operators
        ...
        "\\rank": "\\operatorname{rank}",
        "\\nullity": "\\operatorname{nullity}",
        // Additional common academic abbreviations
        "\\R": "\\mathbb{R}",
        "\\C": "\\mathbb{C}",
        "\\Q": "\\mathbb{Q}",
        "\\Z": "\\mathbb{Z}",
...
function processMathEquationsInContainer(container) {
    ...
    const bareMathRegex = /(?:^|[\s(:=;,-])((?:\\(?:frac|dfrac|tfrac|sqrt|sum|int|lim|vec|bar|hat|dot|cdot|times|leq|geq|neq|approx|infty|alpha|beta|gamma|delta|theta|lambda|mu|sigma|pi|sin|cos|tan|log|ln|left|right|text|mathrm|mathbf|mathbb|ext|extker|extrange)\b)[^\n]{0,260})(?=$|[\s.,;:!?)]|\n)/g;
    ...
    for (const latexString of candidates) {
        try {
            ...
            katex.render(latexString, spanElement, {
                ...
                macros: macros // <-- HERE: pass custom macros to KaTeX
            });
...
function forceRenderAllEquations() {
    ...
    const run = () => {
        ...
        // .katex-error or is missing a healthy .katex
